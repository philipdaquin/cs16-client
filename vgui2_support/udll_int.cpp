...
#ifndef XASH_DISABLE_FWGS_EXTENSIONS
	memset( &ui::textfuncs, 0, sizeof( ui_extendedfuncs_t ));
#endif
...
#ifndef XASH_DISABLE_FWGS_EXTENSIONS
extern "C" EXPORT int GiveTextAPI( ui_extendedfuncs_t* pTextfuncsFromEngine )
{
	...
	// copy HUD_FUNCTIONS table to engine, copy engfuncs table from engine
	memcpy( &ui::textfuncs, pTextfuncsFromEngine, sizeof( ui_extendedfuncs_t ));
