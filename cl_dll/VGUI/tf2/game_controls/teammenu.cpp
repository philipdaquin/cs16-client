...
{
    if (!Q_stricmp(command, "jointeam 1"))
    {
        engine->ClientCmd("jointeam 1");
        OnClose();
    }
    else if (!Q_stricmp(command, "jointeam 2"))
    {
        engine->ClientCmd("jointeam 2");
        OnClose();
    }
    else if (!Q_stricmp(command, "jointeam 5"))
    {
        engine->ClientCmd("jointeam 5");
        OnClose();
    }
    else if (!Q_stricmp(command, "jointeam 6"))
    {
